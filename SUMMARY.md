...
- **Supabase activation IN PROGRESS (2026-07-22)**: owner created the hosted project (company-account guidance given); next = run migration in SQL Editor, env vars, seed, owner auth user. Pending decision: ADMIN_OPEN_ACCESS override so nickname testers keep forum access after activation.
