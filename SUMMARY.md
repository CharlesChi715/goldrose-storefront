...
├── docs/                # Project specs/guides, SEO/GEO research (geo.md + geo-codex.md), and archive/
...
- **AI-search research done (2026-07-23)**: [docs/geo-codex.md](docs/geo-codex.md) — deep source-led report, storefront audit, and phased plan; [docs/geo.md](docs/geo.md) is the shorter first pass.
