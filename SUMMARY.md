...
- **SEO/GEO plan (2026-07-23)**: [docs/search-discovery-implementation.md](docs/search-discovery-implementation.md) is the implementation source of truth; [docs/geo-intro.md](docs/geo-intro.md) is the source-led AI-search research; [docs/seo-intro.md](docs/seo-intro.md) is the concise verified opportunity map.
