...
- **Bottom nav = owner's cat-button art (2026-07-22)**: PNGs in `public/nav/` (outline idle, `-active` colored shown on own page); tabs Home / Shop / Wholesale / Me (wholesale+me have no pages yet → non-links). Pixel baselines regenerated for the new nav.
