...
| `AI-007` | `PLACEHOLDER`    | `OPEN` | `/account/returns/request-submitted` is a coming-soon scaffold until its frame is Ready-for-dev. | [figma-sync-07-31-feat-figma-sync-0731](sessions/figma-sync-07-31-feat-figma-sync-0731.md) | [Scaffold route](../app/account/returns/request-submitted/page.tsx#L1) |
