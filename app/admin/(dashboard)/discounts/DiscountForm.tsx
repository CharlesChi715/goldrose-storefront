...
export function DiscountForm({
  ...
  function save() {
    ...
    const payload = {
      ...
      minPurchaseCents: minPurchase.trim()
        ...
        : null,
      usageLimit: usageLimit.trim() ? Number.parseInt(usageLimit, 10) || null : null,
      oncePerCustomer,
  ...
  return (
    <Page
      ...
      primaryAction={{ content: t("common.save"), onAction: save, loading: saving }}
    >
      <Layout>
        <Layout.Section>
          <BlockStack gap="400">
            ...
            <Card>
              <BlockStack gap="400">
                ...
                <ChoiceList
                  ...
                  selected={[category]}
                  onChange={(selected) =>
                    setCategory(selected[0] as "products" | "order" | "shipping")
                  }
                />
                {category !== "shipping" ? (
                  <InlineGrid columns={{ xs: 1, md: 2 }} gap="400">
                    <Select
                      ...
                      options={[
                        ...
                        { label: t("discounts.form.valueType.fixed"), value: "fixed_amount" },
                      ]}
                      value={valueType}
                      onChange={(next) => setValueType(next as "percentage" | "fixed_amount")}
                    />
                    <TextField
