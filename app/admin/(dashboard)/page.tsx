...
export default async function AdminHomePage() {
  ...
  return (
    <HomeDashboard
      today={{
        salesCents: today.totalSalesCents.current,
        orders: today.ordersCount.current,
      }}
      week={{
        salesCents: week.totalSalesCents.current,
        orders: week.ordersCount.current,
      }}
      month={{
        salesCents: month.totalSalesCents.current,
        orders: month.ordersCount.current,
      }}
