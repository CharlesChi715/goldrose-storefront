    ...
    <>
      ...
      <div data-el="HOME-NEW-ARRIVALS-HERO-IMG" style={{ ...abs(24, 1532, 384, 170), borderRadius: "15px 15px 0 0", overflow: "hidden" }}>
        ...
        <img
          ...
          width={525}
          height={192}
          style={{ ...abs(-96, -10, 525, 192), display: "block", objectFit: "cover", maxWidth: "none" }}
        />
      </div>
      ...
      >
        ...
        <div style={{ ...abs(0, 0, 182, 96), borderRadius: "15px 15px 0 0", overflow: "hidden" }}>
          ...
          <img
            ...
            width={639}
            height={817}
            style={{ ...abs(-66, -313, 639, 817), display: "block", maxWidth: "none" }}
          />
        </div>
        {/* 378:212 */}
        <div
      ...
      >
        ...
        <div style={{ ...abs(0, 0, 170, 99), borderRadius: "15px 0 0 15px", overflow: "hidden" }}>
          ...
          <img
            ...
            width={588}
            height={896}
            style={{ ...abs(-34, -689, 588, 896), display: "block", objectFit: "cover", maxWidth: "none" }}
          />
        </div>
        {/* 159:79 */}
        <div
        ...
        <img
          ...
          width={180}
          height={36}
          style={{ ...abs(186, 50.5, 180, 36), display: "block", objectFit: "none", objectPosition: "left center" }}
        />
      </Link>
      ...
      <img
        ...
        width={140}
        height={22}
        style={{ ...abs(141, 2293, 140, 22), display: "block", objectFit: "none", objectPosition: "center center" }}
      />
