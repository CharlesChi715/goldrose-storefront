...
function ProcurementHero() {
  return (
    <>
      ...
      >
        Bulk orders, corporate gifting, wedding events and wholesale
        partnerships.
      </div>
      <BackButton
        fallback="/account"
...
const SERVICES = [
  {
    ...
    gw: 23,
    gh: 23,
    title: "Dedicated Quotes",
    tx: 19,
    desc: "Pricing by volume and need",
    dx: 20,
  },
  {
    x: 108.67,
    ...
    tx: 113.67,
    desc: "Apply for product samples",
    dx: 114.67,
  },
  {
    x: 203.33,
    ...
    tx: 208.33,
    desc: "Engraving, cards and packaging",
    dx: 209.33,
  },
  {
    x: 298,
    ...
    tx: 303,
    desc: "Dedicated end-to-end service",
    dx: 304,
  },
];
...
function ProcurementServices() {
  return (
    <div
      style={{ ...abs(16, 676, 398, 184), background: CARD, borderRadius: 14 }}
    >
      <div
        style={{
          ...abs(14, 16, 266, 18),
...
function PurchasingNeeds({
  ...
  return (
    <div
      style={{ ...abs(16, 874, 398, 290), background: CARD, borderRadius: 14 }}
    >
      <div
        style={{
          ...abs(14, 16, 329, 18),
...
const STEPS = [
  {
    ...
    title: "Submit needs",
    ty: 83,
    desc: "Basic details and quantity",
    dy: 100,
    dh: 10,
  },
  {
    ...
    ty: 78,
    desc: "A specialist prepares options",
    dy: 95,
    dh: 20,
  },
  {
    ...
    ty: 78,
    desc: "Approved accounts get support",
    dy: 95,
    dh: 20,
  },
];
...
function ThreeStepProcess({
  ...
  return (
    <div
      style={{ ...abs(16, 1178, 398, 204), background: CARD, borderRadius: 14 }}
    >
      <div
        style={{
          ...abs(14, 16, 198, 18),
      ...
      {STEPS.map((s) => (
        <div key={s.n}>
          <div
            style={{
              ...abs(s.x + 44, s.ny, 24, 15),
              ...txt(12, 14.52, "#D4AF37", "center"),
              fontWeight: 700,
            }}
          >
            {s.n}
          ...
          <div
            style={{
              ...abs(s.x + 2, s.dy, 108, s.dh),
              ...txt(8.5, 10.29, MUTED, "center"),
              fontWeight: 400,
              whiteSpace: "normal",
            }}
          >
...
export function BusinessLogin() {
  ...
  const [sending, setSending] = useState<null | "request" | "consultation">(
    null,
  );
  ...
  async function submitAuth() {
    ...
    if (codeStep) {
      ...
      if (verifyError)
        setError(
          "That code didn’t match. Request a new one if it has expired.",
        );
      return;
    }
  ...
  async function sendEnquiry(kind: "request" | "consultation") {
    ...
    try {
      ...
      if (!response.ok || !body.ok) {
        setError(
          body.error ?? "Could not send that just now — please try again.",
        );
      } else {
        setNotice(
          kind === "consultation"
      ...
      >
        ...
        >
          ...
          <input
            ...
            placeholder={
              codeStep ? "6-digit code" : "Enter your business email"
            }
