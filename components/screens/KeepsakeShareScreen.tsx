...
export function KeepsakeShareScreen() {
  return (
    ...
    >
      ...
      <div
        style={{
          ...sCard(36, 126, 358, 588, { bg: CREAM, stroke: false }),
          boxShadow: `inset 0 0 0 1px ${GOLD}, ${SHADOW}`,
        }}
      />
      <div
        style={{
      ...
      <img
        ...
        width={28}
        height={28}
        style={{ ...abs(201, 163, 28, 28), display: "block" }}
      />
      <div
        className={playfair.className}
        style={{
          ...abs(36, 212, 358),
          ...txt(24, 28, GOLD, "center"),
          fontWeight: 500,
        }}
      >
        The 4th recipient
      ...
      <img
        ...
        width={278}
        height={228}
        style={{ ...abs(76, 274, 278, 228), borderRadius: 8, display: "block" }}
      />
      <div
        style={{
          ...abs(286, 284, 74, 74),
      ...
      {DETAILS.map((row, i) => (
        <div key={row.text}>
          <Glyph
            ...
            ink={row.ink}
          />
          <div style={{ ...abs(112, 578 + i * 24, 230), ...txt(11, 20, INK) }}>
            {row.text}
          </div>
        </div>
      ))}
      ...
      <div
        style={{ ...abs(74, 652, 282, 40), background: INK, borderRadius: 8 }}
      />
      <div
        className={playfair.className}
        style={{
          ...abs(84, 660, 262),
          ...txt(11, 22, CREAM, "center"),
          fontStyle: "italic",
        }}
      >
      ...
      <div
        className={playfair.className}
        style={{ ...abs(36, 730, 358), ...txt(16, 28, INK), fontWeight: 500 }}
      >
        Share your card
      </div>
      {SHARE.map((item) => (
            ...
            <div
              style={{
                ...
                ...txt(
                  20,
                  20,
                  item.label === "Save image" ? INK : GOLD,
                  "center",
                ),
              }}
            >
      ...
      <div style={{ ...abs(36, 886, 358), ...txt(9, 16, INK, "center") }}>
        Your card is ready to share or save.
      </div>
    </ScaleFrame>
  );
}
