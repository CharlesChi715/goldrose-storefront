...
export function PreferencesScreen() {
  ...
  return (
    <ScaleFrame height={932} background={CREAM} fontClass={notoSC.className} nav={false}>
      ...
      <img src="/veloria/screens/1523-1077.png" alt="" width={40} height={42} style={{ ...abs(22, 64, 40, 42), display: "block", pointerEvents: "none" }} />

      {/* hero card */}
      <div style={sCard(16, 118, 398, 120)} />
      <div style={{ ...abs(36, 152, 255), ...txt(13, 20, INK), whiteSpace: "pre-line" }}>
        {"Manage how we communicate with you\nand personalize your experience."}
      </div>
      <img src="/veloria/screens/1523-1020.svg" alt="" width={72} height={72} style={{ ...abs(314, 142, 72, 72), display: "block" }} />

      {/* marketing preferences */}
      <div style={sCard(16, 250, 398, 326)} />
      <div style={{ ...abs(34, 268, 300), ...txt(16, 20, INK) }}>Marketing preferences</div>
      <div style={{ ...abs(34, 296, 350), ...txt(10, 16, INK) }}>Choose how you want to receive updates and promotions.</div>
      <Row y={328} icon="1523-1029" iconBox={[48, 352, 24, 24]} title="Email updates" note="Receive news, offers, and updates via email." on={email} onFlip={() => setEmail((v) => !v)} />
      <Row y={404} icon="1523-1037" iconBox={[48, 428, 24, 24]} title="SMS notifications" note="Receive order updates and offers via SMS." on={sms} onFlip={() => setSms((v) => !v)} />
      <Row y={480} icon="1523-1045" iconBox={[48, 504, 24, 24]} title="Push notifications" note="Get updates about orders and promotions." on={push} onFlip={() => setPush((v) => !v)} />

      {/* cookie preferences */}
      <div style={sCard(16, 588, 398, 160)} />
      <div style={{ ...abs(34, 604, 300), ...txt(16, 20, INK) }}>Cookie preferences</div>
      <div style={{ ...abs(34, 631, 350), ...txt(10, 16, INK) }}>Manage how we use cookies and similar technologies.</div>
      <Row y={660} icon="1523-1057" iconBox={[48, 684, 24, 24]} title="Cookie settings" note="Allow cookies to enhance your experience." on={cookies} onFlip={() => setCookies((v) => !v)} />

      {/* privacy card */}
      <div style={sCard(16, 760, 398, 144, { bg: PINK })} />
      <img src="/veloria/screens/1523-1068.svg" alt="" width={24} height={24} style={{ ...abs(34, 782, 24, 24), display: "block" }} />
      <div className={playfair.className} style={{ ...abs(72, 780, 270), ...txt(16, 28, INK), fontWeight: 500 }}>
        Your privacy matters
      </div>
      <div style={{ ...abs(72, 810, 270), ...txt(10, 16, INK), whiteSpace: "pre-line" }}>
        {"We’re committed to protecting your privacy and\ngiving you control over your data and experience."}
      </div>
      <img src="/veloria/screens/1523-1073.svg" alt="" width={58} height={58} style={{ ...abs(342, 832, 58, 58), display: "block" }} />
    </ScaleFrame>
  );
}
