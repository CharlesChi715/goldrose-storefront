...
const REMINDERS = [
  {
    month: "AUG",
    day: "25",
    title: "Anniversary with Emma",
    date: "Aug 25, 2025",
    meta: "7 days before  •  Email + SMS",
  },
  {
    month: "SEP",
    day: "03",
...
export function RemindersScreen() {
  ...
  return (
    ...
    >
      ...
      <div
        className={playfair.className}
        style={{ ...abs(108, 199, 160), ...txt(21, 28, INK), fontWeight: 600 }}
      >
        3 upcoming
      </div>
      ...
      />
      <div style={{ ...abs(76, 728.1, 180), ...txt(11.5, 13.8, INK) }}>
        Email reminders
      </div>
      <Toggle
        y={726}
      ...
      <div style={{ ...abs(76, 758.1, 180), ...txt(11.5, 13.8, INK) }}>
        SMS reminders
      </div>
      <Toggle
        y={756}
