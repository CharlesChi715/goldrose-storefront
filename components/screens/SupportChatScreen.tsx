...
const USER_BUBBLES = [
  { box: [228, 300, 188, 76], text: "Hi, I have a question about\nmy order #GRB-20260821.", textW: 160, time: "11:54 AM", timeX: 344, timeY: 358, tickX: 388 },
  { box: [230, 516, 184, 66], text: "When will my order\nbe shipped?", textW: 156, time: "11:56 AM", timeX: 342, timeY: 564, tickX: 386 },
  { box: [290, 740, 124, 52], text: "Thank you!", textW: 96, time: "11:57 AM", timeX: 342, timeY: 774, tickX: 386 },
] as const;
...
export function SupportChatScreen() {
  return (
    <ScaleFrame height={932} background="#FFFFFF" fontClass={notoSC.className} nav={false}>
      ...
      <BackButton fallback="/care" src="/veloria/screens/1523-1524.png" style={abs(13, 17, 40, 43)} />
      <div className={playfair.className} style={{ ...abs(80, 17, 270), ...txt(22, 28, INK), fontWeight: 500 }}>
        GoldRose Support
      </div>
      <div style={{ ...abs(80, 54, 8, 8), background: "#2EB24F", borderRadius: 4 }} />
      <div style={{ ...abs(96, 48, 230), ...txt(10, 16, INK) }}>We’re here to help 24/7</div>
      ...
      <div style={{ ...abs(120, 88, 278), ...txt(9, 16, CREAM) }}>Your conversation is secure and handled with care.</div>

      {/* order context card — the mock's own order */}
      <div style={sCard(16, 138, 398, 126, { bg: CREAM, r: 12 })} />
      <div style={{ ...abs(30, 150, 255), ...txt(9, 16, INK) }}>✦&nbsp;&nbsp;You may be asking about this order</div>
      <div style={{ ...abs(292, 146, 106, 24), background: INK, borderRadius: 7 }}>
        <span style={{ position: "absolute", left: 0, right: 0, top: 4, ...txt(8, 16, GOLD, "center") }}>Automatically linked</span>
      </div>
      <img src="/veloria/screens/1523-1481.png" alt="" width={82} height={78} style={{ ...abs(30, 176, 82, 78), borderRadius: 8, display: "block" }} />
      <div style={{ ...abs(128, 181, 200), ...txt(12, 20, INK) }}>Gold Preserved Rose – 24K</div>
      <div style={{ ...abs(128, 205, 190), ...txt(9, 16, INK) }}>Classic collection&nbsp;&nbsp;·&nbsp;&nbsp;Qty 1</div>
      <div style={{ ...abs(128, 230, 90), ...txt(14, 20, INK) }}>$129</div>
      <div style={sCard(314, 220, 84, 32, { bg: INK, r: 8, stroke: false })} />
      <div style={{ ...abs(314, 226, 84), ...txt(9, 16, CREAM, "center") }}>✓ Attached</div>

      <div style={{ ...abs(0, 272, 430), ...txt(9, 16, INK, "center") }}>Today, 11:54 AM</div>
      ...
      {USER_BUBBLES.map((bubble) => {
        ...
        return (
          <div key={bubble.text}>
            ...
            <Glyph src="1523-1491" x={bubble.tickX + 10} y={bubble.timeY + 5} w={10} h={6} ink={[10, 6]} />
          </div>
        );
      })}
      {AGENT_BUBBLES.map((bubble) => {
        ...
        return (
          <div key={bubble.text}>
            ...
            <img src="/veloria/screens/1523-1495.svg" alt="" width={28} height={28} style={{ ...abs(18, bubble.avatarY, 28, 28), display: "block" }} />
      ...
      <div style={sCard(16, 872, 398, 46, { bg: CREAM, r: 12, shadow: false })} />
