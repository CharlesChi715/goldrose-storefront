...
|                  |                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **What this is** | The single naming doc for **components**, in both senses used in this project: reusable Figma components (`ELDREVE/Button`) and in-page components — the page bands and controls tagged `data-el` in code (`HOME-HERO-SECTION`). Successor to `docs/ixd/element-names.md` (removed 2026-07-30; old proposal in git history) — the vocabulary word is now **component**, never "element". |
...
1. **A Figma component** is a reusable design piece the design team draws once
   and instances everywhere — `ELDREVE/Button` — so its name describes a
...
1. **Reuse.** A component's name is how a designer finds the right piece to
   reuse: when every button is named `ELDREVE/Button`, there is one button to
...
2. **Design → code contract.** The name is also the contract with code: a
   developer implementing a screen maps `ELDREVE/Button` straight to the
