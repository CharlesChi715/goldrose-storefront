...
> Updated 2026-08-04 (AI-020): `/account/signup` is now the **only** login page — the second login screen this trace originally quoted (`ShoppingLogin`, ELDREVE frame 74:53) is deleted, and `/account` redirects there when signed out.
