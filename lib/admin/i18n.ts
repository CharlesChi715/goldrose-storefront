...
const en = {
  ...
  "form.cost.ph": "18.50",
  "form.sku.ph": "e.g. GR-ROSE-RED",
  "form.barcode.ph": "e.g. 0712345678905",
  "form.quantity.ph": "0",
  "form.weight.ph": "12.5",
  "form.origin.ph": "CN",
  "form.hs.ph": "7117.19",
  "form.option.name.ph": "e.g. Color",
  "form.option.values.ph": "e.g. Red, Pink, Blue",
  "form.seo.pageTitle.ph": "e.g. 24K Gold Dipped Eternal Rose | ELDREVE",
  "form.seo.metaDescription.ph":
    "e.g. A real rose preserved and finished in 24K gold — a keepsake gift that lasts.",
  "form.seo.handle.ph": "e.g. 24k-gold-dipped-eternal-rose",
  "form.productType.ph": "e.g. Gold Dipped Rose",
  "form.vendor.ph": "e.g. ELDREVE",
  "form.tags.ph": "e.g. signature, anniversary, gift-ready",
  "form.position.ph": "1",
  ...
  "form.position.help": "Sort order on /shop — lower numbers come first.",
  "form.save": "Save",
  ...
  "settings.legal.title": "Legal business identity",
  "settings.legal.help":
    "Published in the site footer and on the Contact & Legal Notice page, and required by payment providers. The legal name publishes on its own — enter it as soon as you have it. The postal address is separate: US email law requires it in order emails, which carry no address block until it is filled in.",
  "settings.legal.legalName": "Legal name of business",
  "settings.legal.registrationNumber": "Business registration number",
  "settings.legal.address": "Registered business address",
  "settings.legal.addressHelp": "One line per row; end with the country.",
  ...
  "home.map.title": "Home page map",
  "home.map.hint":
    "The whole page, drawn to scale. Each link is exactly as tall as the part of the page it opens — click one to edit that part.",
  "home.map.scale": "Drawn to scale — the live page is",
  "home.map.share": " of the page",
  "home.map.top": "at the very top",
  "home.map.noArea": "no area of its own",
  "home.map.notShown": "not on the page",
...
const zh: Partial<Record<AdminMessageKey, string>> = {
  ...
  "form.compareAt.ph": "89.99",
  "form.cost.ph": "18.50",
  "form.sku.ph": "例如：GR-ROSE-RED",
  "form.barcode.ph": "例如：0712345678905",
  "form.quantity.ph": "0",
  "form.weight.ph": "12.5",
  "form.origin.ph": "CN",
  "form.hs.ph": "7117.19",
  "form.option.name.ph": "例如：颜色",
  "form.option.values.ph": "例如：红色, 粉色, 蓝色",
  "form.seo.pageTitle.ph": "例如：24K 镀金永生玫瑰 | ELDREVE",
  "form.seo.metaDescription.ph":
    "例如：以真实玫瑰保鲜并镀上 24K 金——一份可以长久保存的礼物。",
  "form.seo.handle.ph": "例如：24k-gold-dipped-eternal-rose",
  "form.productType.ph": "例如：镀金玫瑰",
  "form.vendor.ph": "例如：ELDREVE",
  "form.tags.ph": "例如：signature, anniversary, gift-ready",
  "form.position.ph": "1",
  "form.shortName": "简称",
  "form.shortName.help":
  ...
  "form.tags": "标签（用逗号分隔）",
  "form.position": "排序位置",
  "form.position.help": "在 /shop 页的排序——数字越小越靠前。",
  "form.save": "保存",
  "form.duplicate": "复制",
  "form.archive": "存档",
  "form.unarchive": "取消存档",
  ...
  "order.fulfill.carrier": "承运商",
  "order.fulfill.carrier.other": "其他（手动粘贴跟踪链接）",
  "order.fulfill.tracking": "运单号",
  "order.fulfill.trackingUrl": "物流跟踪链接（可选）",
  "order.fulfill.trackingUrl.help": "留空将根据承运商和运单号自动生成链接。",
  ...
  "settings.legal.title": "企业法定信息",
  "settings.legal.help":
    "显示在网站页脚和“联系方式与法律声明”页面，收款服务商也要求提供。企业法定名称可单独发布 — 拿到后请尽快填写。注册地址是另一项：美国邮件法规要求订单邮件中包含地址，未填写时邮件不含地址栏。",
  "settings.legal.legalName": "企业法定名称",
  "settings.legal.registrationNumber": "营业执照注册号",
  "settings.legal.address": "注册营业地址",
  "settings.legal.addressHelp": "每行一条，最后一行填写国家/地区。",
  ...
  "home.preview": "查看首页",
  "home.jump": "跳转到板块",
  "home.map.title": "首页缩略图",
  "home.map.hint":
    "整个页面的等比缩略图。每个链接的高度与其对应的页面区域完全一致——点击即可编辑该区域。",
  "home.map.scale": "按真实比例绘制——线上页面高",
  "home.map.share": " 的篇幅",
  "home.map.top": "位于页面最顶部",
  "home.map.noArea": "没有独立区域",
  "home.map.notShown": "当前不在页面上",
