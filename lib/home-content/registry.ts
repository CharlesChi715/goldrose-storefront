...
export const HOME_SECTIONS = [
  {
    ...
    titleZh: "顶部促销条",
    blurb:
      "The 32px strip above the header. Always visible — it is part of the frame's chrome, not a band. Fill in more than one line and the strip plays them in turn, each sliding up as the next arrives.",
    blurbZh:
      "页眉上方 32px 的横条。始终显示——它属于页面框架，不是可隐藏的板块。填写多行后，横条会依次轮播，每条向上滑出、下一条滑入。",
    band: null,
    fields: [
      {
        id: "slogan",
        ...
        note: "Line 1. Shown as the design's own render until you edit it; ✦ symbols may look slightly different afterwards.",
        noteZh:
          "第 1 行。未编辑前显示设计稿原图；编辑后 ✦ 符号可能与原设计略有差异。",
      },
      // Lines 2–5 ship EMPTY, which is what keeps the design's single-line
      // strip byte-identical until somebody asks for a second message: an
      // empty line is not a slide, so one filled line still renders exactly
      // the markup it did before rotation existed.
      {
        id: "line_2",
        group: "Lines",
        groupZh: "文案行",
        ...
        value: "",
        max: budget(352, 8.5, 0.55),
        note: "Leave empty to keep the strip on one line. Fill it in and the bar starts playing line 1, line 2, … in turn.",
        noteZh: "留空则横条只显示一行。填写后横条会依次轮播第 1 行、第 2 行……",
      },
      {
        id: "line_3",
        group: "Lines",
        ...
        value: "",
        max: budget(352, 8.5, 0.55),
        note: "Optional. Leave empty if you do not need it.",
        noteZh: "可选。不需要时留空。",
      },
      {
        id: "line_4",
      ...
      },
      {
        ...
        group: "Rotation",
        groupZh: "轮播",
        label: "How long each line stays before the next slides up",
        labelZh: "每行停留多久后向上滑出",
        kind: "number",
        value: "5000",
        numMin: 2500,
        numMax: 30000,
        unit: "ms",
        note: "In milliseconds — 1000 is one second. Only used when you have filled in more than one line. Visitors who have asked their device to reduce motion see the lines change without the sliding movement, and the strip pauses while the pointer rests on it.",
        noteZh:
          "单位为毫秒——1000 毫秒为 1 秒。仅在填写了多行时生效。已在设备上开启「减弱动态效果」的访客会看到直接切换、没有滑动；鼠标停留在横条上时会暂停。",
      },
    ],
  },
  {
