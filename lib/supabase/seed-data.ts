...
> {
  ...
  return {
    ...
    page_views: [
      ...
      view("p05", "demo-visitor-james", "demo-session-j1", "/shop", ago(24 * 3 + 1), null, { utm_source: "instagram", utm_campaign: "gifts", utm_content: "rose_daily" }, "GB"),
      view("p06", "demo-visitor-james", "demo-session-j1", "/products/premium-gold-rose-gift-bundle", ago(24 * 3 + 0.8), null, { utm_source: "instagram", utm_campaign: "gifts", utm_content: "rose_daily" }, "GB"),
